...
| Overlay input interception | Host uses transparent/no-activate native styles; annotator capture is bounded to calibrated window and pointing state | WPF/Windows defects could affect focus; manual release testing remains required |
